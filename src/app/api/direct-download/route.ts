...
<body>
    <div class="container">
        ...
        <div class="download-section success">
            <h3>✅ Verlet Swing (811870) - Ready for Download</h3>
            ...
            <div class="file-info">
                <strong>📋 Steam Manifest:</strong> demo_manifest_811870.json<br>
                <strong>🔧 Lua Script:</strong> demo_script_811870.lua
            </div>
        </div>

        <div class="download-section info">
            <h3>🔗 How to Use in Discord</h3>
...
GET /api/direct-download?accessKey=demo_manifest_811870
        ...
        <div class="download-section warning">
            ...
            <ul>
                <li>• These are demo files for Verlet Swing</li>
                <li>• Use your own App ID for custom games</li>
                <li>• Files are Steamtools compatible</li>
    ...
    <script>
        console.log('🚀 Direct download page loaded');
    </script>
</body>
</html>
  `;
