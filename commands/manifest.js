...
const { getTransparencyStatement, getMichaelExplanation } = require('../utils/manifestSource');
...
- Real depot IDs and manifest ID patterns
- Professional-grade educational files

File Structure:
--------------
- Real Steam depot IDs: 228980, 228981, 228982
- Authentic manifest IDs (18+ digit format)
...
Note: These files are generated for educational purposes using
real Steam API data. For production use, please use official
Steam APIs or professional manifest services.`, { name: `README.txt` });
